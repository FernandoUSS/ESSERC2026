...
\section{Reliability of FETs}
\subsection{Hysteresis Characterization}
...
\begin{figure*}[ht]
    ...
    \caption{(a) \textbf{Typical BTI experiments}: The device under test undergoes alternating periods of stress and recovery bias conditions.}
    \label{fig:BTI}
\end{figure*}

\section{Reliability of Inverters}
